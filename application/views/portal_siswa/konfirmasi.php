    ...
    <div class="card-body">
        ...
        <div class="session-card mb-0">
            <div class="row g-2 small">
                ...
                <div class="col-7 fw-bold"><?= $sesi['nama_sesi']; ?></div>
                <div class="col-5 text-muted">Mata Pelajaran</div>
                <div class="col-7 fw-bold"><?= $sesi['nama_mata_pelajaran']; ?></div>
                <div class="col-5 text-muted">Jenis Pengerjaan</div>
                <div class="col-7 fw-bold"><?= $sesi['label_pengerjaan'] ?? $sesi['jenis_pengerjaan']; ?></div>
                <div class="col-5 text-muted">Kategori</div>
                <div class="col-7 fw-bold"><?= $sesi['nama_kategori_soal']; ?></div>
                <div class="col-5 text-muted">Jumlah Soal</div>
                <div class="col-7 fw-bold"><?= $sesi['jumlah_soal']; ?></div>
                <div class="col-5 text-muted">Durasi Timer</div>
                <div class="col-7 fw-bold"><?= $sesi['durasi_timer']; ?> menit</div>
            </div>
        </div>
    </div>
</div>
...
<div class="card student-card">
    <div class="card-body">
        ...
        <div class="form-check p-2 ps-4 border rounded-3 bg-light">
            ...
            <label class="form-check-label fw-semibold" for="setuju">Saya sudah membaca dan menyetujui aturan
                pengerjaan.</label>
        </div>
        ...
        <div class="d-flex gap-2 mt-3">
            ...
            <a href="javascript:void(0)" id="btnMulai" class="btn btn-primary btn-touch w-50 disabled"
                onclick="mulaiPengerjaanFullscreen()">Mulai Mengerjakan</a>
        </div>
    </div>
</div>
<style>
