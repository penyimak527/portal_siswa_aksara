                    ...
                    chart: {
                        ...
                        events: {
                            dataPointSelection: function(event, chartContext, config) {
                                const item = data.grafik[config.dataPointIndex];
                                const seri = config.w.config.series[config.seriesIndex];
                                if (!item || !seri || seri.data[config.dataPointIndex] === null) return;
